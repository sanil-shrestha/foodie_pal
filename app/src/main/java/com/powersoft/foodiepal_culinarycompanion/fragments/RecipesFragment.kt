...
class RecipesFragment : Fragment() {
    ...
    private fun generateSampleRecipe() {
        recipeList.add(Recipe("Vegetable Noodle", "12 Mins", R.drawable.ic_noodle, 4.5f, null, "Vegetable noodles are a delicious and healthy alternative to traditional wheat-based noodles. Typically made from vegetables like zucchini, carrots, or sweet potatoes, they offer a nutritious option for those looking to cut down on carbohydrates or incorporate more veggies into their diet."))
        recipeList.add(Recipe("Spaghetti", "30 Mins", R.drawable.ic_spaghetti, 4.8f, null, "Spaghetti is a classic Italian pasta known for its long, thin cylindrical shape. Made from durum wheat semolina, spaghetti is one of the most popular and widely consumed pasta varieties worldwide."))
        recipeList.add(Recipe("Chicken Spaghetti", "32 Mins", R.drawable.ic_chicken_spaghetti, 5f, null, "\n" +
